...
BEGIN
	...
	WHERE p.id = p_IdUsuario;

	#Almacenamos la Consulta
	SET v_SqlQuery = CONCAT('UPDATE tbl_cliente p SET
	                                p.id_usuario_socio = ',p_IdSocio,',
	                                p.codigo = ',p_CodigoCliente,',
									p.rif = ',p_Rif,',
									p.razon_social = ',p_RazonSocial,',
	...
	CALL sp_bitacora(1, \"update_cliente\", p_IdUsuario, p_IdUsuario, \"tbl_cliente\", v_SqlQuery, null, @NewData, p_IpAction, @response);
