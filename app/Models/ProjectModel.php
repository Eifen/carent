...
class ProjectModel extends Model
{
    ...
    public static function getRegisterHoursInfo($userId)
    {
        ...
        $getUsersAsign = DB::select('call sp_get_register_projects(?)', [$userId]);
    ...
    public static function getProjectInfo($projectId)
    {
        ...
        return array(
            ...
            "closureProject" => DB::table('projects_closure_control')->where('project_id', '=', $projectId)->first(),
            "billings" => DB::select('call sp_get_billing_info(?)', [$projectId]),
