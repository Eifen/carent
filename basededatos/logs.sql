...
-- Tiempo de generación: 15-07-2020 a las 09:32:29
...
CREATE TABLE `tbl_cliente` (
  ...
  `avenida_calle_fiscal` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `edificio_quinta_fiscal` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `piso_fiscal` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_fiscal` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ciudad_fiscal` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telefono_fiscal` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pagina_web` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_fiscal` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_estatus` int(11) DEFAULT NULL,
  `id_usuario_socio_nuevo` int(11) DEFAULT NULL,
  `id_usuario_gerente_nuevo` int(11) DEFAULT NULL,
  `rif_nuevo` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nit_nuevo` int(11) DEFAULT NULL,
  `razon_social_nuevo` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_parroquia_fiscal_nuevo` int(11) DEFAULT NULL,
  `avenida_calle_fiscal_nuevo` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `edificio_quinta_fiscal_nuevo` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `piso_fiscal_nuevo` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_fiscal_nuevo` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ciudad_fiscal_nuevo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telefono_fiscal_nuevo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pagina_web_nuevo` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_fiscal_nuevo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tbl_concepto_horas_no_cargables` (
  ...
  `id_estatus` int(11) DEFAULT NULL,
  `descripcion_nuevo` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_estatus_nuevo` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_proyecto` (
  ...
  `descripcion` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_cliente` int(11) DEFAULT NULL,
  `fecha_contratacion` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `monto` decimal(15,2) DEFAULT NULL,
  `id_moneda` int(11) DEFAULT NULL,
  `id_estatus` int(11) DEFAULT NULL,
  `descripcion_nuevo` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_cliente_nuevo` int(11) DEFAULT NULL,
  `fecha_contratacion_nuevo` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tbl_usuario` (
  ...
  `nombre_1` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nombre_2` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `apellido_1` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `apellido_2` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `nombre_1_nuevo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nombre_2_nuevo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `apellido_1_nuevo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `apellido_2_nuevo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
