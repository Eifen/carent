<template>
    ...
    <!-- Monto -->
        <div class="mb-3" v-if="scope.inputCurrenciesSelect != 0">
            <label for="Value">Monto <span :class="scope.formClass.requiredField">*</span></label>
    ...
    <!-- Divisiones -->
        <div class="mb-3">
            <label for="Departments">Divisiones <span :class="scope.formClass.requiredField">*</span></label>
            <!-- Departamentos -->
            <div class="input-group">
                <Multiselect
    ...
    <div class="mb-3" v-if="scope.inputDepartments != 0">
            <label for="HoursAssigned">Horas Totales <span :class="scope.formClass.requiredField">*</span></label>
            <div class="input-group">
