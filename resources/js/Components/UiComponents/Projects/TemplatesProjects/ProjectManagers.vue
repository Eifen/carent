<template lang="">
    <!-- Carga de horas -->
    <span class="badge text-bg-info" v-if="scope.inputDepartments.length != 0"
        >Indique la cantidad de horas por división</span
    >
    <fieldset
        :class="scope.formClass.fieldset"
    ...
    >
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                {{
                    scope.dataSelect.managersPerDepartment[cursor]
                        .departmentName
                }}
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                >
                    ...
                    <option
                        v-for="(select2, cursor2) in scope.dataSelect
                            .managersPerDepartment[cursor].managersDepartment"
                        :key="cursor2"
                        :value="select2.user_id"
                    >
                        {{ select2.user_name }}
                    </option>
                </select>
        ...
        <div
            class="mb-3"
            v-if="
                scope.dataSelect.managersPerDepartment[cursor].selectManager !=
                0
            "
        >
            <label for="Hours"
            ...
            <div class="input-group">
                ...
                <input
                    ...
                    @input="
                        $emit(
                            'total-hours',
                            scope.dataSelect.managersPerDepartment
                        )
                    "
                />
                <span class="input-group-text" id="basic-addon11" v-if="isEdit">
                    <project-additional-modal
                        ...
                        id-modal="additionalHours"
                        :modal-data="scope.dataSelect.additionalHours"
                        table-modal-title="Lista de horas"
                        table-modal-insert="Agregar hora adicional"
                    ></project-additional-modal>
                </span>
            </div>
        </div>
