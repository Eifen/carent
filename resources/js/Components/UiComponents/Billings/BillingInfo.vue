    ...
    methods: {
        ...
        getTotalBilling() {
            const totalBilling = this.infoProject.billings.reduce((total, billing) => {
                ...
                if ((billing.billing_concept_id == 1 || billing.billing_concept_id == 2 || billing.billing_concept_id == 6) && billing.status_id != 2) return total + parseFloat(billing.billing_value);
                return total
            }, 0);
