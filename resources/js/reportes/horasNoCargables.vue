      ...
      <b-form class="row" v-if="formFiltro.mostrar">
        ...
        <b-form-group
          ...
          <multiselect :clear-on-select="false"
                       :disabled="formFiltro.campos.concepto.disabled"
                       :multiple="true"
                       :options="formFiltro.campos.concepto.listado"
                       ...
                       v-model="formFiltro.campos.concepto.value">
...
<style lang="less">
  @import '../../less/reportes/totalHorasNoCarg.less';
</style>
...
<script>
  ...
  export default {
      ...
      beforeCreate: function(){
        ...
        axios.get('/dataRepTotalNoHorasCarg')
        .then(function (response) {
          ...
          if(response.status === 200 && response.data.response === true){
            ...
            self.tabla.encabezado = [
              ...
              { key: 'horas_no_cargables', label: 'Total Horas Cargadas a Concepto' },
            ...
            self.formFiltro.campos.concepto.listado = response.data.concepto;        
            ...
            self.formFiltro.campos.concepto.disabled = false;
      ...
      methods: {
        ...
        registroTabla: function(datos){
          ...
          datos.forEach((item, i) => {
            ...
            const data = {
              ...
              horas_no_cargables: item.horas_no_cargables,
              total: item.total,
            };
        ...
        buscar: function(){
          ...
          self.formFiltro.campos.concepto.disabled = true;
          ...
          //Evaluamos como filtraremos los conceptos
          if(self.formFiltro.campos.concepto.value.length === 0 && self.formFiltro.campos.concepto.listado.length > 1){
            var param_concepto = null;
          }else if(self.formFiltro.campos.concepto.value.length > 0){
            var param_concepto = self.formFiltro.campos.concepto.value;
          }else if(self.formFiltro.campos.concepto.value.length === 0 && self.formFiltro.campos.concepto.listado.length === 1){
            var param_concepto = self.formFiltro.campos.concepto.listado[0].id;
          }else{
            var param_concepto = null;
          }
          ...
          axios.get('/buscarRepTotalHorasNoCarg', {params: parametros})
          .then(function (response) {
        ...
        limpiarFiltro: function(){
          ...
          self.formFiltro.campos.concepto.value = [];
