...
<style lang="less">
  @import '../../less/reportes/ultimaCargaHorasNoCargables.less';
</style>
...
<script>
  ...
  export default {
      ...
      beforeCreate: function(){
        ...
        axios.get('/dataRepUltimaCargaHorasNo')
        .then(function (response) {
          ...
          if(response.status === 200 && response.data.response === true){
            ...
            self.tabla.encabezado = [
              ...
              { key: 'fecha', label: 'Fecha De Ultima Carga De Horas No Cargables' },
            ];

            self.tabla.registros = self.registroTabla(response.data.ultimaCarga);

            if(response.data.ultimaCarga.length === 0){
      ...
      methods: {
        ...
        buscar: function(){
          ...
          axios.get('/buscarUltimaCargaHorasNo', {params: parametros})
          .then(function (response) {
