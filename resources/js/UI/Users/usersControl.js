...
const createUser = createApp({
    ...
    created() {
        ...
        this.getSession("/usuarios/deleteUpdateData");
    },
    methods: {
        /**
        ...
        updateUser(Data) {
            ...
            Data.Status == 0
                ? (this.paramDTOEdit.IdStatus = null)
                : (this.paramDTOEdit.IdStatus = Data.Status);
            ...
            const routesSelfDTO = {
                post: "/usuarios/update/updateUser",
                redirect: "/usuarios",
                self: this,
            };
            CrudUi.controlCrud(routesSelfDTO, paramsToPost);
        ...
        validateNivel2(DataToReview) {
            ...
            DataToReview.IdParish == 0
                ? (this.paramDTOUser.IdParish = 0)
                : (this.paramDTOUser.IdParish = DataToReview.IdParish);
            DataToReview.IdCargo == 0
                ? (this.paramDTOUser.IdCargo = 0)
                : (this.paramDTOUser.IdCargo = DataToReview.IdCargo);
            DataToReview.IdDivision == 0
                ? (this.paramDTOUser.IdDivision = 0)
                : (this.paramDTOUser.IdDivision = DataToReview.IdDivision);
            ...
            !Validate.Phone(DTONumeroSecundario).response
                ...
                : (this.paramDTONewContact.SecondPhone =
                      this.decryptPhone(DTONumeroSecundario));

            this.paramDTONewContact.FirstPhone = this.decryptPhone(
                DataToReview.FirstPhone
            );
...
if (
    document.getElementById("create-users") !== null ||
    document.getElementById("update-user") !== null
) {
    if (document.getElementById("create-users") !== null)
        createUser.mount("#create-users");
    if (document.getElementById("update-user") !== null)
        createUser.mount("#update-user");
