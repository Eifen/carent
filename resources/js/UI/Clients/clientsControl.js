...
const clientsControl = createApp({
    ...
    methods: {
        ...
        newClient(dataParams) {
            ...
            const routesSelfDTO = {
                post: "/clientes/create/newClient",
                redirect: "/clientes",
                self: this,
            };
        ...
        updateClient(dataParams) {
            ...
            const routesSelfDTO = {
                post: "/clientes/update/updateClient",
                redirect: "/clientes",
                self: this,
            };
            CrudUi.controlCrud(routesSelfDTO, paramsToPost);
    ...
    created() {
        ...
        this.getSession("/clientes/deleteUpdateData");
    },
    mixins: [componentsUI, methodsUI, dataUI, watchUI],
});

if (
    document.getElementById("create-client") !== null ||
    document.getElementById("update-client") !== null
) {
    if (document.getElementById("create-client") !== null)
        clientsControl.mount("#create-client");
    if (document.getElementById("update-client") !== null)
        clientsControl.mount("#update-client");
