...
const planillaControl = createApp({
    ...
    created() {
        ...
        this.getSession("planilla/deleteAuEva");
...
if (
    document.getElementById("create-autoevaluation") !== null ||
    document.getElementById("update-autoevaluation") !== null
) {
    if (document.getElementById("create-autoevaluation") !== null)
        planillaControl.mount("#create-autoevaluation");
    if (document.getElementById("update-autoevaluation") !== null)
        planillaControl.mount("#update-autoevaluation");
