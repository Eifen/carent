...
if (
    document.getElementById("info-autoevaluation") !== null
) {
    if (document.getElementById("info-autoevaluation") !== null)
        planillaControl.mount("#info-autoevaluation");
