  ...
  methods:{
    ...
    crear: function(){
      ...
      if(formValido){
        ...
        //Obtenemos valores
        let parametros = {
          nuevaDivision: self.form.nuevaDivision.value
        }
        ...
        axios.post('/crearDivision', parametros)
    ...
    refreshView: function(){
      window.location.href = "/formNuevaDivision";
    }
