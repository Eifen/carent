...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @vite('resources/css/formHorasNoCargables.css')
    ...
    <body>
              ...
              <div class="modal-body">
                <form id="formCargarHoras" class="row">
                  ...
                  <div class="form-group col-6" id="fechaHasta">
                    ...
                    <datetime
                      @input="limpiarMensajeError('#formCargarHoras .fechaHasta')"
              ...
              <div class="modal-body">
                <form id="formModificarHoras" class="row">
                  ...
                  <div class="form-group col-6" id="fechaHasta">
                    <label>Fecha Hasta</label>
                    <datetime
                      @input="limpiarMensajeError('#formModificarHoras .fechaHasta')"
      ...
      @vite('resources/js/formHorasNoCargables.js')
