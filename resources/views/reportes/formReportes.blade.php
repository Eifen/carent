...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @vite('resources/css/formReportes.css')
    ...
    <body>
      ...
      <b-container fluid id="app" v-on:keypress="keyboard">
        ...
        <b-row align-h="center" align-v="center" v-cloak>
          <b-col cols="12">
            ...
            <reporte-13 v-if="formReportes.reportes.verReporte.id === 30" :key="formReportes.reportes.verReporte.key"></reporte-13>
          </b-col>
        </b-row>
      ...
      @vite('resources/js/formReportes.js')
