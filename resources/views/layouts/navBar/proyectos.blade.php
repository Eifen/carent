<div>
    ...
    <div class="header-nav-links-item-dropdown" :style="controlDropdown.projects.style" @mouseover="openDropDown('projects')" @mouseout="closeDropDown('projects')">
        <div class="header-nav-links-item-dropdown-content"><a href="{{URL::route('projects')}}">Control de proyectos</a></div>
        <div class="header-nav-links-item-dropdown-content"><a href="{{URL::route('assign')}}">Asignacion de proyectos</a></div>
